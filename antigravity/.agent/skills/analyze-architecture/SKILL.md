...
description: Audits architectural consistency by comparing current code structure against architecture.md. Detects drift, violations, and undocumented changes.
---

# Analyze Architecture — Drift Detection

## Context
1. Read `.agent/memory/architecture.md` — the source of truth
...
## Output
- If consistent: `Done: Architecture consistent.`
